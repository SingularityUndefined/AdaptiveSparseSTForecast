...
unrolled-EM or EM-style traini
...
$$
\mathbf{A}^\text{new} = \Pi_{[0,1]^{N\times N}} \left( S_{\eta\gamma}\left(\mathbf{A} -\eta {\mathbf{W}^o}^\text{new}(\tilde{\mathbf{S}}-\tilde{\mathbf{R}})\right)\right), \quad \tilde{S}_{ij}=S_{ii}+S_{jj} -2S_{ij},\quad \tilde{R}_{ij}=R_{ii}+R_{jj}-2R_{ij}
$$
...
$$
A_{ij}=\Pi_{[0,1]}\left( S_{\eta\gamma}\left(A_{ij} - {\eta} {W^o}^\text{new}_{ij}\left(\frac{1}{N}\sum_{k=1}^N (x_i^{(k)}-x_j^{(k)})^2 - (\mathbf{e}_i-\mathbf{e}_j)^\top \mathbf{R}(\mathbf{e}_i-\mathbf{e}_j)\right) \right)\right)
$$
...
- kNN neighbor list `(N, k ** 2 - 1)`.

|                                                              |                                                              |                                                              |
| ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| ![image-20251229153508056](C:\Users\qij21\AppData\Roaming\Typora\typora-user-images\image-20251229153508056.png) | ![image-20251229142611937](C:\Users\qij21\AppData\Roaming\Typora\typora-user-images\image-20251229142611937.png) | ![image-20251229153446813](C:\Users\qij21\AppData\Roaming\Typora\typora-user-images\image-20251229153446813.png) |
...
| Steps         | 5                                                            | 8                                                            | 12                                                           | 15                                                           |
| ------------- | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| Learned graph | ![image-20251229191022694](C:\Users\qij21\AppData\Roaming\Typora\typora-user-images\image-20251229191022694.png) | ![image-20251229191051326](C:\Users\qij21\AppData\Roaming\Typora\typora-user-images\image-20251229191051326.png) | ![image-20251229191128626](C:\Users\qij21\AppData\Roaming\Typora\typora-user-images\image-20251229191128626.png) | ![image-20251229191147199](C:\Users\qij21\AppData\Roaming\Typora\typora-user-images\image-20251229191147199.png) |
...
| Steps         | 5                                                            | 8                                                            | 12                                                           | 15                                                           |
| ------------- | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| Learned graph | ![image-20251229191311540](C:\Users\qij21\AppData\Roaming\Typora\typora-user-images\image-20251229191311540.png) | ![image-20251229191346630](C:\Users\qij21\AppData\Roaming\Typora\typora-user-images\image-20251229191346630.png) | ![image-20251229191407001](C:\Users\qij21\AppData\Roaming\Typora\typora-user-images\image-20251229191407001.png) | ![image-20251229191425915](C:\Users\qij21\AppData\Roaming\Typora\typora-user-images\image-20251229191425915.png) |
| edges left    | 394 / 396                                                    | 198 / 396                                                    | 155 / 396                                                    | 151 / 396                                                    |

**Method 3:** CHOLMOD, $\mathbf{R}=(L+\epsilon I)^{-1}$, $\epsilon=0.005$

| Steps         | 5                                                            | 8                                                            | 12                                                           | 15       |
| ------------- | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | -------- |
| Learned Graph | ![image-20251229191630575](C:\Users\qij21\AppData\Roaming\Typora\typora-user-images\image-20251229191630575.png) | ![image-20251229191643917](C:\Users\qij21\AppData\Roaming\Typora\typora-user-images\image-20251229191643917.png) | ![image-20251229191708133](C:\Users\qij21\AppData\Roaming\Typora\typora-user-images\image-20251229191708133.png) | Exploded |
...
https://github.com/SingularityUndefined/AdaptiveSparseSTForecast/blob/main/demo_sparse.ipynb
